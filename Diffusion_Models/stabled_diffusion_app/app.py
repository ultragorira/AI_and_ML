...
device = "cuda"
pipe = StableDiffusionPipeline.from_pretrained(modelid, revision="fp16", torch_dtype=torch.float16, use_auth_token=os.environ.get("HUGGING_FACE_TOKEN")) 
pipe.to(device) 
...
def generate(): 
    ...
    image.save('stable_diff_pic.png')
